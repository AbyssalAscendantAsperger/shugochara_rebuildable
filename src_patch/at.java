public final class at {
   ...
   public final String a(String var1) {
      ...
      int var4;
      var4 = (var4 = (int)(this.c[0] >>> 3) & 63) >= 56 ? 120 - var4 : 56 - var4;
      this.a(a, var4);
      this.a(var3, 8);
      a(this.f, this.b, 16);
      this.e = "";
      ...
      for(int var5 = 0; var5 < 16; ++var5) {
         ...
         char[] var8;
         (var8 = new char[2])[0] = var6[var2 >>> 4 & 15];
         var8[1] = var6[var2 & 15];
         this.e = var10003.append(new String(var8)).toString();
      }
   ...
   private long a(long var1, long var3, long var5, long var7, long var9, long var11, long var13) {
      long var21;
      return (long)((int)(var21 = var1 + (var3 & var5 | ~var3 & var7) + var9 + var13) << (int)var11 | (int)var21 >>> (int)(32L - var11)) + var3;
   }

   private long b(long var1, long var3, long var5, long var7, long var9, long var11, long var13) {
      long var21;
      return (long)((int)(var21 = var1 + (var3 & var7 | var5 & ~var7) + var9 + var13) << (int)var11 | (int)var21 >>> (int)(32L - var11)) + var3;
   }

   private long c(long var1, long var3, long var5, long var7, long var9, long var11, long var13) {
      long var21;
      return (long)((int)(var21 = var1 + (var3 ^ var5 ^ var7) + var9 + var13) << (int)var11 | (int)var21 >>> (int)(32L - var11)) + var3;
   }

   private long d(long var1, long var3, long var5, long var7, long var9, long var11, long var13) {
      long var21;
      return (long)((int)(var21 = var1 + (var5 ^ (var3 | ~var7)) + var9 + var13) << (int)var11 | (int)var21 >>> (int)(32L - var11)) + var3;
   }

   private void a(byte[] var1, int var2) {
      byte[] var3 = new byte[64];
      int var4 = (int)(this.c[0] >>> 3) & 63;
      if ((this.c[0] += (long)(var2 << 3)) < (long)(var2 << 3)) {
         this.c[1]++;
      }

      this.c[1] += (long)(var2 >>> 29);
      int var5 = 64 - var4;
      if (var2 >= var5) {
