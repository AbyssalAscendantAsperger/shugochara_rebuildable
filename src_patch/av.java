...
public final class av extends Canvas implements Runnable {
   ...
   public static final String[] V = new String[]{"Game mới", "Chơi tiếp", "Game khác", "Âm nhạc", "Trợ giúp", "Giới thiệu", "Thoát"};
   ...
   private static final String[] bg = new String[]{
      "Nhiệm vụ phụ là nguồn kiếm tiền rất quan trọng", "Tiệm rèn giúp nâng cấp trang bị và chế tạo vật phẩm", "Nước sự sống có thể giúp bạn hồi sinh tại chỗ.", "Độ khó ải càng cao thì phần thưởng nhận được càng lớn", "Tắt nhạc có thể giúp trải nghiệm game mượt mà hơn", "Kỹ năng có thể được nâng cấp trong menu kỹ năng.", "Lên cấp nhận điểm kỹ năng, giúp tăng mạnh lực chiến"
   };
   ...
   public final void a() {
      ...
      try {
         ...
         for(int var6 = 1; var6 < R.length; ++var6) {
            ((ae)null).i = ((ae)null).i + "&" + R[var6];
         }

         var1.close();
      } catch (Exception var4) {
         b();
         System.out.println("Thao tác không hợp lệ->>" + var4.getMessage());
      }
   }
   ...
   public final void run() {
      ...
      while(B) {
         var1 = System.currentTimeMillis() + (long)((ae)null).a;
         ((a)null).b();
         this.repaint();
   ...
   public static final void c() {
      ...
      ((j)null).c(-1);
      if (((l)null).e != null) {
         for(int var1 = ((l)null).e.length - 1; var1 >= 0; --var1) {
            if (((l)null).e[var1] != null) {
               ((l)null).e[var1].d();
               ((l)null).e[var1] = null;
            }
         }
   ...
   public static final void d() {
      ...
      ((j)null).d = 0;
      ((a)null).a();
      ((ab)null).a(0, 0, ((j)null).a(), ((j)null).b());
      ((ac)null).a(0, 0, ((j)null).a(), ((j)null).b());
      ((ac)null).a((ac)null, true);
      ((ac)null).a(d(((ac)null).k), true);
      k();
      Object var3 = null;
      x var1 = null;
   ...
   public static final long a(short[] var0) {
      long var1 = 0L;
      int var3 = ((j)null).a() - 1 >> 8;
      int var4 = ((j)null).b() - 1 >> 8;
      int var5;
   ...
   public static final void g() {
      for(int var0 = bu >= 0 ? bu : 0; var0 < x; ++var0) {
         ...
         if (aH != null) {
            ...
            if (aH.m(((x)null).H) && ((t.V[2] & ((aa)null).aN) != ((aa)null).aN || aH.V[3] == 6 || aH.V[3] == 8)) {
               if (aI && aH.ay >= 0) {
                  aH.R();
               } else {
                  aH.d();
   ...
   private static void B() {
      if (r != null) {
         for(int var0 = 0; var0 < 1; ++var0) {
            if (r[var0] != null) {
               if (r[var0].m(((x)null).G)) {
                  r[var0].c();
               }

               if (r[var0].m(((x)null).H)) {
                  r[var0].D();
                  if (aI) {
                     if (r[var0].ay >= 0) {
                        r[var0].R();
   ...
   public static final void a(String var0) {
      ...
      try {
         ...
         ((q)null).a(var3 = new DataOutputStream(var2));
   ...
   private static void g(Graphics var0) {
      ...
      var0.setFont(((ae)null).c);
      var0.drawString("Bật âm thanh?", 120, 160, 33);
      var0.drawString("Có", 0, 320, 36);
      var0.drawString("Không", 240, 320, 40);
   }
   ...
   private static void H() {
      ...
      ((ac)null).a((short)0, (short)0, (short)240, (short)320);
      ((d)null).d();
   }
   ...
   private static void J() {
      if (aU || aR) {
         if (aM && ((d)null).l) {
            ...
            if (((a)null).e(16384) || ((a)null).e(4096) || U == 4096 || U == 16384) {
               Y = false;
               ((a)null).a();
            }
         } else if (Z) {
            if (((a)null).e(8192) || U == 32768 || U == 8192 || ((a)null).e(32768)) {
               Z = false;
               ((a)null).a();
            }
         } else if (!((a)null).e(16384) && !((a)null).e(4096) && U != 4096 && U != 16384) {
            if (((a)null).e(4) || ((a)null).e(1)) {
               --X;
               if (!Q && X == 2) {
                  --X;
               }
            ...
            switch(X) {
               ...
               case 6:
                  if (Q) {
                     ...
                     ((d)null).a("Bạn có chắc muốn thoát game?", "Đồng ý", "Trở về", 1);
                     aM = true;
                  }
            }
   ...
   private static void h(Graphics var0) {
      ...
      boolean var1 = false;
      boolean var2 = false;
      ((o)null).a(var0, "<<", 80, 273, 17, 16708687, 0);
      ((o)null).a(var0, ">>", 160, 273, 17, 16708687, 0);
      ((o)null).a(var0, V[X], 120, 273, 17, X != 2 ? 16708687 : 16711680, 0);
      if (((d)null).p) {
         ((d)null).a("Không có dữ liệu lưu nào!", "Đồng ý", null, 1);
         ((d)null).p = false;
      }

      if (Z) {
         ((o)null).a(var0, 592136);
         ((d)null).a(var0, 2, 2, 234, 314, 4211247);
   ...
   private static void L() {
      aV = ((n)null).a(3, new short[]{188, 45, 50, 60});
      aW = ((n)null).a(6, new short[]{0, 176, 62, 100});
      aX = ((n)null).a(5, new short[]{176, 244, 64, 56});
   }
   ...
   private static void j(Graphics var0) {
      ((d)null).a(var0, aY, "Chuyển", "Trở về");
   }
   ...
   private static void k(Graphics var0) {
      ...
      if (ba == 1) {
         ...
         var0.setColor(65535);
         ((o)null).a(var0, "Lời khuyên", 120, 115, 33, 16755828, 9766440);
         ((o)null).a(var0, bg[bh], 1, bi, 17, 5893631, 4325631);
         if (be != null) {
            be.c = 60;
            be.d = 0;
            be.e = bs / 4 + 3;
   ...
   private static void l(Graphics var0) {
      ((o)null).b(var0, 0, 0, 240, 320, -1728053248);
      var0.setFont(((ae)null).c);
      var0.setColor(65535);
      var0.drawString("TẠM DỪNG", 120, 140, 33);
      ((o)null).a(var0, "Nhấn phím giữa hoặc phím 5 để quay lại game", 20, 160, 200, 40);
   }
   ...
   private static void W() {
      if (((ai)null).f[4] == 100 && ((ai)null).e[0] <= 25) {
         ((ai)null).e[0] = 26;
         if (!t.b.c(3)) {
            t.b.b(3);
         }
   ...
   public static final void c(Graphics var0) {
      ...
      ((n)null).a(var0);
      ((j)null).a(var0, ((ac)null).h(), ((ac)null).j());
      a(var0);
      ((n)null).j();
      ((n)null).o();
      if (D == 4 && ((n)null).h <= 0 && ((n)null).i <= 0 && H > -1) {
         ((d)null).a(var0, 0);
      }
   ...
   private static void ab() {
      ...
      } else if (((a)null).e(1024)) {
         ((d)null).d = 2;
         ((d)null).a(11);
         return;
      }

      if (((a)null).e(2048) || bp <= 0) {
         aa();
         c();
         a((byte)2);
      }
   ...
   private static void o(Graphics var0) {
      i var1;
      (var1 = ((l)null).e[t.V[6]]).a(var0, 17, var1.b(17) - 1, t.Z(), t.aa(), false, t.X);
      boolean var2 = false;
      boolean var3 = false;
      boolean var4 = false;
      boolean var5 = false;
      ((o)null).a(var0, bk, String.valueOf(bp), 120, 130, 33, 1, 0, 10);
      var0.setColor(12303291);
      ((o)null).b(var0, 30, 140, 180, 100, -1728053248);
      ...
      if (bo > 0) {
         ...
         ((o)null).a(var0, "Nhấn phím “*” để dùng", 120, 160, 33, 16755828, 9766440);
         ((o)null).a(var0, "Nước Sự Sống", 120, 190, 33, 5893631, 4325631);
      } else {
         ((o)null).a(var0, "Không đủ Nước Sự Sống", 120, 190, 33, 5893631, 4325631);
         var0.setColor(16755828);
         ((o)null).a(var0, "Nhấn phím “*” để đến cửa hàng mua", 30, 140, 180, 100);
      }
      ...
      if (bl != null) {
         ((o)null).a(var0, bl, "x" + String.valueOf(bo), 128, 210, 33, 1, 0, 11);
      }

      ((o)null).a(var0, "Nhấn phím # để về menu chính", 240, 0, 24, 15975757, 592136);
   }
   ...
   private static void p(Graphics var0) {
      ((o)null).a(var0, 0);
      var0.setColor(65535);
      var0.drawString("CHÚC MỪNG PHÁ ĐẢO!", 120, 160, 17);
   }

   public static final void a(Graphics var0, int var1, int var2, int var3) {
      if (var1 >= 0) {
         short var4;
         if ((var4 = e[1]) >= 0 && var4 <= ((l)null).e.length) {
            i var5;
            if ((var5 = ((l)null).e[var4]) == null) {
               System.out
                  .println(
   ...
   public static final boolean a(x var0) {
      aa var1 = t;
      short[] var2 = var0.M();
      boolean var3 = ((o)null).a(var1.V[8], var1.V[9], var2[0], var2[1], var2[2], var2[3]);
      if (var0.p(16)) {
         return var3;
      } else if (Math.abs(var0.V[8] - var1.V[8]) + Math.abs(var0.V[9] - var1.V[9]) < ((j)null).c() * 3) {
         return true;
      } else {
         ...
         short var6 = var0.V[8];
         short var7 = var0.V[9];
         return ((o)null).a(var1.V[8], var1.V[9], var6 - (var4 >> 1), var7 - (var5 >> 1), var6 + (var4 >> 1), var7 + (var5 >> 1));
      }
   }

   public static final boolean a(x var0, x var1) {
      if (var0.o(16) && var1.o(16)) {
         return ((o)null).a(var0.M(), var1.M());
      } else if (var0.o(16)) {
         short[] var3 = var0.M();
         return ((o)null).a(var1.V[8], var1.V[9], var3[0], var3[1], var3[2], var3[3]);
      } else if (var1.o(16)) {
         short[] var2 = var1.M();
         return ((o)null).a(var0.V[8], var0.V[9], var2[0], var2[1], var2[2], var2[3]);
      } else {
         return Math.abs(var0.V[8] - var1.V[8]) + Math.abs(var0.V[9] - var1.V[9]) < ((j)null).c() * 3;
      }
   }
   ...
   private static void ad() {
      ...
      try {
         (var0 = ((o)null).c("cfg.bin")).readByte();
         b = var0.readByte();
         ((j)null).a(b);
         c = new int[b + 1];
         ...
         ((d)null).a(var0);
         ((l)null).b = var0.readShort();
         if (((l)null).e == null) {
            ((l)null).e = new i[((l)null).b];
         }

         ((j)null).a = var0.readShort();
         ((l)null).c = var0.readShort();
         if (((l)null).f == null) {
            ((l)null).f = new aq[((l)null).c];
         }

         ((j)null).f = new aq[((j)null).a];
         ((l)null).d = new short[b][];

         for(int var9 = 0; var9 < b; ++var9) {
            ((l)null).d[var9] = new short[var0.readShort()];

            for(int var2 = 0; var2 < ((l)null).d[var9].length; ++var2) {
               ((l)null).d[var9][var2] = var0.readShort();
            }
         }
   ...
   private static void k(int var0) {
      ...
      try {
         (var1 = ((o)null).c("scs.bin")).skip((long)c[var0]);
         k = var1.readShort();
         p = var1.readShort();
         var1.readInt();
         a = var1.readShort();
   ...
   private static int ae() {
      if (ad == 0) {
         ...
         if (ad == 20) {
            ((l)null).a(H, G);
            ((l)null).a("amn.bin", ((l)null).a, ((l)null).e, ((l)null).f);
         } else if (ad == 70) {
            k(H);
         } else if (ad == 85) {
            ((ai)null).a(H);
   ...
   private static void e(int var0, int var1) {
      ((j)null).c(var0);
      long[] var2 = new long[(((l)null).b >> 6) + 1];
      if (var1 != -1) {
         for(int var3 = ((l)null).d[var1].length - 1; var3 >= 0; --var3) {
            short var4 = ((l)null).d[var1][var3];
      ...
      for(int var10 = 0; var10 < ab[var0].length; ++var10) {
         ...
         for(int var5 = ((l)null).d[var12].length - 1; var5 >= 0; --var5) {
            short var6;
            int var7 = (var6 = ((l)null).d[var12][var5]) >> 6;
      ...
      int[] var11 = new int[((l)null).b];
      int var13 = 0;

      for(int var14 = 0; var14 < ((l)null).b; ++var14) {
         int var16 = var14 >> 6;
         int var17 = var14 % 64;
      ...
      ((l)null).a(var15, ((l)null).e, ((l)null).f);
      ((ai)null).c();
      bu = -1;
   }
   ...
   private static void l(int var0) {
      ...
      try {
         (var1 = ((o)null).c("stg.bin")).readByte();
      ...
      if (w != null) {
         ...
         for(int var1 = w.length - 1; var1 >= u; --var1) {
            ...
            if ((var0 = w[var1]) != null) {
               ...
               if (var0.m(((x)null).G) || ((o)null).a(var0.V[8] - ((ac)null).h(), var0.V[9] - ((ac)null).j(), ((ac)null).f[0], ((ac)null).f[1], ((ac)null).f[2], ((ac)null).f[3])) {
                  c(var0);
               }
            }
         }
   ...
   private static void c(x var0) {
      ...
      var0.aH = ((o)null).a(var0.V[8] - ((ac)null).h(), var0.V[9] - ((ac)null).j(), ((ac)null).g[0], ((ac)null).g[1], ((ac)null).g[2], ((ac)null).g[3]) || f[var0.V[0]] == 96;
      if (var0.aH) {
         d(var0);
      }
   }
   ...
   public static final void l() {
      ...
      for(int var15 = ((j)null).d - 1; var15 >= 0; --var15) {
         ((j)null).a((byte)2, ((j)null).e[var15], (byte)-1);
      }
      ...
      for(byte var3 = 0; var3 < x; ++var3) {
         if ((var16 = w[y[var3]]) != null && var16.m(((x)null).I) && !var16.p(16)) {
            short var0 = var16.V[8];
            short var1 = var16.aE != 0 ? var16.aE : var16.V[9];
            if (var0 >= 0 && var1 >= 0 && var0 <= ((j)null).a() && var1 <= ((j)null).b()) {
               int var4;
               if ((var4 = ((j)null).a((byte)2, var0, var1)) <= -1) {
                  if (-83 < var4 && var4 <= -2) {
                     var4 = -var4 + -2;
                  } else {
                     ((j)null).e[((j)null).d++] = ((j)null).a((byte)2, var0, var1, (byte)(-var3 + -2));
                     var4 = var3;
                  }

                  if (((j)null).b[var4] < 5) {
                     ((j)null).c[var4 * 5 + ((j)null).b[var4]] = (short)var3;
                     ++((j)null).b[var4];
                  }
               }
            } else {
      ...
      if (r != null) {
         for(int var20 = 0; var20 < 1; ++var20) {
            if (r[var20] != null && r[var20].m(((x)null).I)) {
               ...
               boolean var7 = false;
               int var8 = 0;
               if ((var5 = ((j)null).a((byte)2, var13, var14)) == -82) {
                  var5 = -1;
               }
               ...
               if (-83 < var5 && var5 <= -2) {
                  ...
                  ((j)null).e[((j)null).d++] = ((j)null).a((byte)2, var13, var14, (byte)(-var18 + -2));
                  var5 = var18;
               }

               if (((j)null).b[var5] < 5) {
                  var8 = (var8 = var5 * 5) + ((j)null).b[var5];
                  ((j)null).c[var8] = (short)var18;
                  ++((j)null).b[var5];
               }
            }
         }
      ...
      for(int var10 = ((j)null).b.length - 1; var10 >= 0; --var10) {
         int var21;
         int var24 = (var21 = var10 * 5) + ((j)null).b[var10];

         for(int var11 = var21; var11 < var24; ++var11) {
            int var12 = var11;
            if (var11 > var21) {
               short var25;
               if ((var25 = ((j)null).c[var11 - 1]) < 80) {
                  var29 = w[y[var25]];
               } else {
                  var29 = r[var25 - 80];
               }
               ...
               while(var12 > var21 && g[((x)var29).V[0]] > g[((x)var9).V[0]]) {
                  ((o)null).b(((j)null).c, var12, var12 - 1);
                  --var12;
               }
            }
         }
   ...
   private static final void m(int var0) {
      ...
      try {
         for(int var6 = w.length - 1; var6 >= 0; --var6) {
            ...
            if (var1 != null && var1.m(((x)null).J) && !(var1 instanceof f)) {
               var1.a(var5);
            }
   ...
   private static byte[] a(String var0, int var1, ByteArrayOutputStream var2, DataOutputStream var3) throws Exception {
      ...
      if (var0.equals("DNFP_RMS_GAME")) {
         ...
         while(var7.hasMoreElements()) {
            ...
            var3.writeUTF(var6);
            ((o)null).a((byte[])bv.get(var6), var3);
         }
         ...
         var3.writeBoolean(((aa)null).bd);
         var3.writeBoolean(((d)null).v);
         System.out.println("-------write end--------");
         var4 = var2.toByteArray();
      } else {
         var4 = null;
   ...
   private static boolean a(String var0, int var1, DataInputStream var2) throws Exception {
      if (var0.equals("DNFP_RMS_GAME")) {
         ...
         for(int var4 = 0; var4 < var6; ++var4) {
            ...
            bv.put(var5, ((o)null).a(var2));
         }

         ((ac)null).a(var2);
         ((d)null).h = ((o)null).e(var2);
         System.out.println("-------read end--------");
      } else if (var0.equals("DNFP_RMS_CONFIG")) {
         ((am)null).b = var2.readBoolean();
         ...
         if (var0.equals("DNFP_RMS_SUPER_VARIATES")) {
            ...
            ((aa)null).bd = var2.readBoolean();
            ((d)null).v = var2.readBoolean();
            System.out.println("-------read end--------");
         }
      }
   ...
   static {
      ...
      String[] var3 = new String[]{
         "", "", "", "Phòng Nghị Sự", "Nghĩa Trang", "Thành Laster", "Ngoại Thành", "Rừng Laster", "Hang Động Tà Ác", "Lối Vào Ngục", "Ngục Tầng 2", "Đầm Lầy Laster", "Saint Erlan", "Ngục Tầng 3", "Phòng Giam", "Lối Vào Cung Điện", "Cung Điện Dưới Lòng Đất", "", ""
      };
      ...
      String[] var7 = new String[]{"Gió lạnh lùa tóc rối", "Sao mờ chiếu áo đơn", "Phất tay cưỡi gió bước", "Để lại dấu sương sa"};
      av = 40;
      bw = new int[7];
   }
}
