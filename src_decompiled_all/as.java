...
public final class as {
   ...
   public static final Hashtable a(Vector var0, int var1, int var2, int var3, int var4, String var5, String var6, String var7) {
      Hashtable var8;
   ...
   public static final Hashtable a(String var0, Image var1, int var2, String var3, String var4, String var5, String var6, int var7) {
      Hashtable var8;
   ...
   public static final Hashtable a(
      String var0, String var1, int var2, String var3, String var4, String var5, String var6, Font var7, int var8, int var9, int var10, int var11, int var12
   ) {
      Hashtable var13;
   ...
   public static final void a(Vector var0, int var1, int var2, int var3) {
      Vector var4;
   ...
   public static final Hashtable a(
      String var0, String var1, int var2, String var3, String var4, String var5, String var6, Font var7, int var8, int var9, int var10, String var11, int var12
   ) {
      Hashtable var13;
   ...
   public static final Hashtable a(String var0, int var1, int var2, int var3) {
   ...
   public static final void a(Hashtable var0, String var1) {
      if (var0 != null) {
         Vector var2;
   ...
   public static final Hashtable a(int var0, int var1, int var2, int var3) {
      Hashtable var4;
   ...
   public static final void a(Hashtable var0, String var1, String var2, String var3) {
      var0.put("c", var1);
      var0.put("e", var2);
      var0.put("f", var3);
   }
   ...
   public static final Object[] a(Graphics var0, Hashtable var1, int var2, Hashtable var3, int var4, int var5, int[] var6) {
   ...
   public static final Object[] a(Graphics var0, Hashtable var1, int var2, int var3, Hashtable var4, int var5, int var6, int var7, int var8, int[] var9) {
      ...
      if (var1.get("u").toString() == "n" && var17.length() > 0) {
         ...
         while(var18.length() < var17.length()) {
            var18 = var18 + "*";
         }
   ...
   public static final Object[] a(Graphics var0, Hashtable var1, int var2, int var3, Hashtable var4, int var5, int var6, int var7, int[] var8) {
   ...
   public static final Object[] a(Graphics var0, Hashtable var1, int var2, int var3, int var4) {
   ...
   public static final void b(Graphics var0, Hashtable var1, int var2, int var3, int var4) {
   ...
   public static final void a(Graphics var0, Hashtable var1, int var2, int var3) {
   ...
   public static final void a(Graphics var0, int var1, int var2, int var3, int[] var4, String var5, String var6) {
   ...
   public static final void a(Graphics var0, Hashtable var1, int var2, int[] var3, Vector var4) {
      int var5 = Integer.parseInt(var1.get("r").toString());
      int var6 = Integer.parseInt(var1.get("q").toString());
      ...
      if (var10 == "n") {
         ...
         var0.setColor(var3[6]);
         int var14 = (int)(System.currentTimeMillis() % (long)((var5 - 4) * 10)) / 10;
         var0.fillRect(var14 + var7 + 1, var8 + var6 - 15 + 2, 5, 11);
         var0.fillRect(var14 + var7 + 8, var8 + var6 - 15 + 2, 5, 11);
         var0.fillRect(var14 + var7 + 16, var8 + var6 - 15 + 2, 5, 11);
      } else {
         if (var11 == "y") {
   ...
   public static final String a(String var0, Hashtable var1) {
      Object var2;
