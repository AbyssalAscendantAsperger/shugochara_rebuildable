...
public final class af extends Canvas implements Runnable, CommandListener {
   ...
   private af(MIDlet var1, String var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   private void b() {
      ...
      try {
         byte[] var1 = a(4, null, "upg_api_private");
      ...
      if (at == null || at.equals("")) {
         if (aN != null && !aN.equals("") && aN.length() >= 8) {
            String[] var12 = b(as.a("smsclist", ai), "=#=");
            String[] var16 = b(as.a("smsinfo", ai), "=#=");
            String[] var3 = b(as.a("smstext", ai), "=#=");
            ...
            for(int var4 = 0; var4 < var12.length; ++var4) {
               if ((at == null || at.equals("")) && var12[var4].equals("all")) {
                  ...
                  for(int var6 = 0; var6 < var5.length; ++var6) {
                     if (aN.startsWith(var5[var6])
                        || aN.startsWith("+" + var5[var6])
                        || aN.startsWith("+86" + var5[var6])
                        || aN.startsWith("86" + var5[var6])
                        || aN.startsWith("0" + var5[var6])) {
                        at = var16[var4];
                        au = var3[var4];
                     }
                  }
            ...
            at = c("7D7026B0B3", at);
            if (as.a("smsendday", ai) != null && !as.a("smsendday", ai).equals("")) {
               this.aw = Integer.parseInt(as.a("smsendday", ai));
            } else {
               this.aw = 7;
            }
         } else {
      ...
      String var13 = as.a("urlpath", ai);
      aa = "http://" + c("7D7026B0B3", var13);
      this.ab = aa + c("7D7026B0B3", as.a("upointpayUrl", ai));
      this.ac = aa + c("7D7026B0B3", as.a("updatesmsUrl", ai));
      this.ad = aa + c("7D7026B0B3", as.a("payresultUrl", ai));
      this.ae = aa + c("7D7026B0B3", as.a("discountUrl", ai));
      this.aV = as.a("ydsmsport", ai);
      this.aW = as.a("ltsmsport", ai);
      this.af = Integer.parseInt(as.a("forcecharge", ai));
      aK = as.a("idType", ai);
      aJ = as.a("idName", ai);
      if (d(200).equals("")) {
         aE = aG;
      ...
      aZ = Integer.parseInt(as.a("conntimeout", ai)) * 1000;
      aI = as.a("coinName", ai);
      this.ap = as.a("launchsite", ai);
      this.aq = as.a("phonetype", ai);
      this.ar = as.a("backupcode", ai);
      this.m = new int[10];
      if (!as.a("colors", ai).equals("")) {
         String[] var14 = b(as.a("colors", ai), ",");

         for(int var17 = 0; var17 < var14.length; ++var17) {
            this.m[var17] = Integer.parseInt(var14[var17]);
         }
      }

      String[] var15 = b(as.a("payMethod", ai), ",");
      Vector var18 = new Vector();
      Vector var19 = new Vector();

      for(int var20 = 0; var20 < var15.length; ++var20) {
         String var22 = "";
         int var7 = Integer.parseInt(var15[var20]);
         ...
         var19.addElement(var22);
      }

      this.aL = new String[var18.size()];
      this.aM = new String[var18.size()];
      var18.copyInto(this.aL);
      var19.copyInto(this.aM);

      try {
         this.aj = Integer.parseInt(as.a("payDefault", ai));
      ...
      F = as.a("y", "", 5, "n", "", as.c, a(8, 1), as.a, this.m[1], this.m[0], this.m[1], g - 10, j, 60, "y");
      G = as.a("y", "", 5, "n", "", as.c, a(5, 1), as.a, this.m[1], this.m[0], this.m[1], g - 10, j, 60, "n");
      H = as.a("y", "", 5, "n", "", as.c, a(63, 1), as.a, this.m[1], this.m[0], this.m[1], g - 10, j, 60, "n");
      I = as.a("y", "", 5, "n", "", as.c, a(74, 1), as.a, this.m[1], this.m[0], this.m[1], g - 10, j, 60, "n");
      J = as.a("y", "", 5, "c", "", as.c, "savepassword", as.a, this.m[1], this.m[0], this.m[1], 14, 14);
   ...
   private void c() {
      ...
      this.n = new Vector();
      Vector var1;
      (var1 = new Vector()).addElement(as.a("n", this.i, 0, "", "", as.c, "", -1));
      this.n.addElement(as.a(var1, g, this.i.getHeight(), this.m[0], -1, "n", "", ""));
      as.a(this.n, 1, this.m[2], g);
   }

   private void a(String var1, String var2, String var3, String var4) {
      this.c();
      Vector var5;
      (var5 = new Vector()).addElement(as.a("n", a(63, 1), 5, "", "", as.c, "", as.b, this.m[0], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[6], -1, "n", "", ""));
      as.a(this.n, 2, -1, g);
      String[] var6 = a(a(64, 1), as.a, g - 10);

      for(int var7 = 0; var7 < var6.length; ++var7) {
         (var5 = new Vector()).addElement(as.a("n", var6[var7], 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
         this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      }

      as.a(this.n, 2, this.m[2], g);
      (var5 = new Vector()).addElement(as.a("n", "支付密码", 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.e, 0));
      this.n.addElement(as.a(var5, g, j, -1, -1, "n", "", ""));
      (var5 = new Vector()).addElement(H);
      this.n.addElement(as.a(var5, g, j, -1, -1, "n", "", ""));
      as.a(this.n, 5, -1, g);
      (var5 = new Vector()).addElement(as.a("y", a(0, 0), 5, "m", String.valueOf(3), as.c, "", as.b, this.m[1], this.m[4], -1, as.e, g - 10));
      this.n.addElement(as.a(var5, g, j, -1, -1, "n", "", ""));
      as.a(this.o, a(0, 0), var1, var2);
      as.a(this.p, a(1, 0), var3, var4);
      this.ba = true;
      this.u = 4;
   }
   ...
   private void b(String var1, String var2, String var3, String var4) {
      this.c();
      Vector var5;
      (var5 = new Vector()).addElement(as.a("n", a(71, 1), 5, "", "", as.c, "", as.b, this.m[0], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[6], -1, "n", "", ""));
      as.a(this.n, 2, -1, g);
      String[] var6 = a(a(72, 1), as.a, g - 10);
      ...
      this.n.addElement(as.a(var5, g, j, -1, -1, "n", "", ""));
      as.a(this.n, 5, -1, g);
      var6 = a(a(73, 1), as.a, g - 10);

      for(int var16 = 0; var16 < var6.length; ++var16) {
         (var5 = new Vector()).addElement(as.a("n", var6[var16], 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
         this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      }

      (var5 = new Vector()).addElement(as.a("n", a(75, 1), 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      (var5 = new Vector()).addElement(as.a("y", a(77, 1), 5, "t", String.valueOf(3), as.c, "", as.b, this.m[1], this.m[4], -1, as.e, g - 10));
      this.n.addElement(as.a(var5, g, j, -1, -1, "n", "", ""));
      (var5 = new Vector()).addElement(as.a("n", a(76, 1), 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      (var5 = new Vector()).addElement(as.a("y", a(77, 1), 5, "t", String.valueOf(4), as.c, "", as.b, this.m[1], this.m[4], -1, as.e, g - 10));
      this.n.addElement(as.a(var5, g, j, -1, -1, "n", "", ""));
      as.a(this.o, a(0, 0), var1, var2);
      as.a(this.p, a(1, 0), var3, var4);
      this.ba = true;
   ...
   private void c(String var1, String var2, String var3, String var4) {
      this.c();
      Vector var5;
      (var5 = new Vector()).addElement(as.a("n", a(20, 0), 5, "", "", as.c, "", as.b, this.m[0], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[6], -1, "n", "", ""));
      as.a(this.n, 0, this.m[2], g);
      (var5 = new Vector()).addElement(as.a("n", a(a(67, 1), "$(str)", String.valueOf(this.V)), 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      (var5 = new Vector()).addElement(as.a("n", a(66, 1), 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
      var5.addElement(as.a("n", this.aS + "折", a(a(66, 1), as.a) + 5, "", "", as.c, "", as.b, this.m[6], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      (var5 = new Vector()).addElement(as.a("n", a(68, 1), 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
      var5.addElement(as.a("n", this.aT + " U点", a(a(68, 1), as.a) + 5, "", "", as.c, "", as.b, this.m[6], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      (var5 = new Vector()).addElement(as.a("n", a(69, 1), 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
      this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      as.a(this.n, 5, this.m[2], g);
      (var5 = new Vector()).addElement(as.a("y", a(0, 0), 5, "r", A, as.c, "", as.b, this.m[1], this.m[4], -1, as.e, g - 10));
      this.n.addElement(as.a(var5, g, j, -1, -1, "n", "", ""));
      as.a(this.n, 10, this.m[2], g);
      String[] var6 = a(a(70, 1), as.a, g - 10);
      ...
      as.a(this.n, 5, this.m[2], g);
      (var5 = new Vector()).addElement(as.a("n", "优视科技 版权所有", 5, "", "", as.c, "", as.a, this.m[4], -1, -1, as.e, g - 10));
      this.n.addElement(as.a(var5, g, j, this.m[2], -1, "n", "", ""));
      as.a(this.o, a(0, 0), var1, var2);
      as.a(this.p, a(1, 0), var3, var4);
      this.ba = false;
   ...
   private void a(
      String[] var1, Vector[] var2, String var3, String var4, String var5, String var6, String var7, String var8, String var9, String var10, String var11
   ) {
      this.c();

      for(int var13 = 0; var13 < var1.length; ++var13) {
         Vector var12;
         (var12 = new Vector()).addElement(as.a("n", var1[var13], 5, "", "", as.c, "", as.b, this.m[0], -1, -1, as.d, 0));
         this.n.addElement(as.a(var12, g, j, this.m[6], -1, "n", "", ""));
         as.a(this.n, 2, this.m[2], g);

         for(int var14 = 0; var14 < var2[var13].size(); ++var14) {
            String[] var15 = a((String)var2[var13].elementAt(var14), as.a, g - 10);

            for(int var16 = 0; var16 < var15.length; ++var16) {
               (var12 = new Vector()).addElement(as.a("n", var15[var16], 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
               this.n.addElement(as.a(var12, g, j, this.m[2], -1, "n", "", ""));
            }
         }
      ...
      Vector var18;
      (var18 = new Vector()).addElement(as.a("y", var9, 0, var10, var11, as.c, "", as.b, this.m[1], this.m[4], -1, as.e, g));
      this.n.addElement(as.a(var18, g, j, -1, -1, "n", "", ""));
      as.a(this.n, 20, this.m[2], g);
      (var18 = new Vector()).addElement(as.a("n", "优视科技 版权所有", 5, "", "", as.c, "", as.a, this.m[4], -1, -1, as.e, g - 10));
      this.n.addElement(as.a(var18, g, j, this.m[2], -1, "n", "", ""));
      as.a(this.o, var3, var4, var5);
      as.a(this.p, var6, var7, var8);
      this.u = 4;
   }
   ...
   private void d() {
      this.c();
      Vector var1;
      (var1 = new Vector()).addElement(as.a("n", a(20, 0), 5, "", "", as.c, "", as.b, this.m[0], -1, -1, as.d, 0));
      this.n.addElement(as.a(var1, g, j, this.m[6], -1, "n", "", ""));
      as.a(this.n, 0, this.m[2], g);
      String[] var2 = a(this.U, as.a, g - 10);

      for(int var3 = 0; var3 < var2.length; ++var3) {
         (var1 = new Vector()).addElement(as.a("n", var2[var3], 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.d, 0));
         this.n.addElement(as.a(var1, g, j, this.m[2], -1, "n", "", ""));
      }

      (var1 = new Vector()).addElement(as.a("n", a(0, 1), 5, "", "", as.c, "", as.b, this.m[0], -1, -1, as.d, 0));
      this.n.addElement(as.a(var1, g, j, this.m[6], -1, "n", "", ""));
      String[] var11 = a(a(65, 1), as.b, g - 10);

      for(int var9 = 0; var9 < var11.length; ++var9) {
         (var1 = new Vector()).addElement(as.a("n", var11[var9], 5, "", "", as.c, "", as.b, this.m[6], -1, -1, as.d, 0));
         this.n.addElement(as.a(var1, g, j, this.m[2], -1, "n", "", ""));
      }

      as.a(this.n, 5, this.m[2], g);

      for(int var10 = 0; var10 < this.aL.length; ++var10) {
         (var1 = new Vector()).addElement(as.a("y", this.aM[var10], 0, "t", String.valueOf(this.aL[var10]), as.c, "", as.b, this.m[1], this.m[4], -1, as.e, g));
         this.n.addElement(as.a(var1, g, j, -1, -1, "n", "", ""));
         as.a(this.n, 2, this.m[2], g);
      }

      as.a(this.n, 20, this.m[2], g);
      System.out.println("ver:1.0final");
      (var1 = new Vector()).addElement(as.a("n", "优视科技 版权所有", 5, "", "", as.c, "", as.a, this.m[4], -1, -1, as.e, g - 10));
      this.n.addElement(as.a(var1, g, j, this.m[2], -1, "n", "", ""));
      as.a(this.o, a(0, 0), "o", "");
      as.a(this.p, a(1, 0), "p", "");
      this.u = 4;
   ...
   public final void paint(Graphics var1) {
      ...
      as.a(var1, g, h, j, this.m, this.o.get("c").toString(), this.p.get("c").toString());
      if (y != null && y.get("a").toString() == "b") {
         Vector var7 = (Vector)y.get("c");
         Vector var3 = new Vector();

         for(int var4 = 0; var4 < var7.size(); ++var4) {
            String[] var5 = a((String)var7.elementAt(var4), as.a, Integer.parseInt(y.get("r").toString()));
         ...
         if ((var8 = (Vector)var2.get("c")) != null) {
            for(int var4 = 0; var4 < var8.size(); ++var4) {
               ...
               if ((var6 = (var5 = (Hashtable)var8.elementAt(var4)).get("a").toString()) == "2") {
                  as.a(var1, var5, var3, this.l, this.x);
               }

               if (var6 == "5") {
                  as.b(var1, var5, var3, this.l, this.x);
               }

               Object[] var7;
               if (var6 == "1" && (var7 = as.a(var1, var5, var3, this.r, this.l, this.x, this.m)) != null) {
                  this.a(
                     (Hashtable)var7[0],
                     Integer.parseInt(var7[1].toString()),
                     Integer.parseInt(var7[2].toString()),
                     Integer.parseInt(var7[3].toString()),
                     Integer.parseInt(var7[4].toString())
                  );
               }

               if (var6 == "3" && (var7 = as.a(var1, var5, var3, j, this.r, this.l, this.x, g, h, this.m)) != null) {
                  this.a(
                     (Hashtable)var7[0],
                     Integer.parseInt(var7[1].toString()),
                     Integer.parseInt(var7[2].toString()),
               ...
               if (var6 == "6" && (var7 = as.a(var1, var5, var3, j, this.r, this.l, this.x, g, this.m)) != null) {
                  this.a(
                     (Hashtable)var7[0],
                     Integer.parseInt(var7[1].toString()),
                     Integer.parseInt(var7[2].toString()),
   ...
   public final void run() {
      if (aP) {
         ...
         as.a(y = as.a("n", g, h, j), "正在初始化数据，请稍等");
         ...
         try {
            (var1 = RecordStore.openRecordStore("upg_api_private", true, 0, false)).addRecord(var2, 0, 200);
            var1.addRecord(var2, 0, 100);
            var1.addRecord(var2, 0, 500);
            var1.addRecord(var2, 0, 200);
            var1.addRecord(var2, 0, 1);
            var1.addRecord(var2, 0, 1);
            var1.addRecord(var2, 0, 1);
         ...
         if (System.currentTimeMillis() - var9 < 1000L) {
            as.a(1000L - (System.currentTimeMillis() - var9));
         }
      ...
      for(; this.w; as.a(50L)) {
         switch(this.P) {
            case 1:
               if (this.L != null) {
                  TextBox var19 = this.L;
                  af var25 = this;
                  Display var26;
                  Displayable var27 = (var26 = Display.getDisplay(b)).getCurrent();
                  this.K = true;
                  var26.setCurrent(var19);

                  while(var25.K) {
                     as.a(60L);
                  }

                  var26.setCurrent(var27);
               }

               String var20 = this.L.getString();
               if (this.O == this.M) {
                  this.r.put("c", var20);
               }
            ...
            case 4:
               if (y == null) {
                  as.a(y = as.a("n", g, h, j), a(61, 1));
               }

               if (!a(this.an, this.ao, 2000)) {
                  y.put("v", "y");
                  as.a(y, a(7, 0));
                  this.P = 0;
               } else {
                  ...
                  if (this.T < this.V) {
                     String var15 = a(
                        a(
                           a(
                              a(a(a(8, 0) + "，" + a(10, 0), "$(str3)", this.as), "$(str2)", String.valueOf(this.az - this.aB)),
                              "$(str1)",
                        ...
                        "$(str5)",
                        String.valueOf(this.aB + 1)
                     );
                     Vector var23;
                     (var23 = new Vector()).addElement(var15);
                     if (F.get("c").toString() != null && !"".equals(F.get("c").toString())) {
                        var23.addElement(aJ + ":" + " " + F.get("c").toString());
                     }
                     ...
                     var15 = "r";
                     String var3 = B;
                     this.a(new String[]{a(20, 0)}, new Vector[]{var23}, a(0, 0), "o", "", a(1, 0), var15, var3, a(0, 0), "m", String.valueOf(4));
                  } else {
                  ...
                  try {
                     ...
                     (var24 = new DataOutputStream(var18)).writeUTF(var28.an);
                     var24.writeUTF(var28.ao);
                     var24.writeInt(var28.aA);
                     var24.writeInt(var28.aB);
                     var24.writeInt(var28.az);
                     var24.writeUTF(var28.as);
                     var24.writeUTF(as.a("addtimes", ai));
                     var28.am.put(var10, var18.toByteArray());
                     var24.close();
                     var18.close();
                     var28.g();
            ...
            case 6:
               ...
               a(this.R, this.V);
               Vector var22;
               (var22 = new Vector()).addElement(a(5, 0));
               if (!aK.equals("noid")) {
                  var22.addElement(a(89, 1) + ": " + F.get("c").toString());
                  var22.addElement(a(41, 1) + ": " + this.W + " U点");
                  var22.addElement(a(88, 1) + ": " + this.X + " U点");
               }

               this.a(new String[]{a(20, 0)}, new Vector[]{var22}, a(0, 0), "o", "", a(1, 0), "p", "", a(0, 0), "p", "");
               this.d = true;
               y = null;
               this.P = 0;
               break;
            ...
            case 10:
               ...
               if (I.get("c") == null || I.get("c").equals("")) {
                  ...
                  y.put("v", "y");
                  this.P = 0;
               } else if (a(this.aX, "game:" + I.get("c").toString(), 0)) {
                  as.a(y, a(82, 1));
                  y.put("v", "y");
                  this.P = 0;
                  this.a("r", A);
         ...
         if (aE == 1) {
            String var21 = a(14, 0) + a(15, 0) + a(16, 0) + "\n";
            (y = as.a("y", g, h, j)).put("v", "y");
            as.a(y, var21);
            aE = 0;
         }
      }
   ...
   private boolean e() {
      ...
      ap var7 = new ap(var1, Q, var3.toString(), aO, aZ);

      try {
         Hashtable var8;
         if ((var8 = ap.a(var7, Z, "")) == null) {
            as.a(y, "获取短信数据失败，请改用其他手段支付");
            return false;
         }

         int var11 = Integer.parseInt(var8.get("respCode").toString());
         if (var8 == null || var8.equals("") || var11 < 200 || var11 > 299) {
            as.a(y, "获取短信数据失败，请改用其他手段支付");
            return false;
         }
         ...
         if ((var2 = new String((byte[])var8.get("data"), "UTF-8")).startsWith("-102")) {
            if (a(var2, 2, "#").equals("response_null")) {
               as.a(y, "对不起，您所在的地区没有开通短信付费通道，请使用U点进行支付！");
               return false;
            }
      ...
      if (var2.length() > 2) {
         ...
         DataOutputStream var14 = new DataOutputStream(var10);
   ...
   private boolean f() {
      ...
      ap var6 = new ap(var1, Q, var2.toString(), aO, aZ);

      try {
         Hashtable var7;
         if ((var7 = ap.a(var6, Z, "")) == null) {
            as.a(y, "获取U点支付信息失败！");
            return false;
         }
   ...
   private void g() {
      ...
      try {
         ...
         while(var4.hasMoreElements()) {
            ...
            byte[] var7 = (byte[])this.am.get(var5);
            var2.writeUTF(var5);
   ...
   private void i() {
      byte[] var1 = a(3, null, "upg_api_private");
   ...
   private static int b(String var0) {
      String var1;
      return !(var1 = String.valueOf(al.get(var0))).equals("null") ? Integer.parseInt(var1) : 0;
   }
   ...
   private static String k() {
      if (ak != null && !ak.equals("")) {
         ...
         String var7 = String.valueOf(a(var3));
   ...
   private static void l() {
      byte[] var0 = a(1, null, "upg_api_private");
   ...
   private static String[] m() {
      ...
      ByteArrayInputStream var1 = new ByteArrayInputStream(a(2, null, "upg_api_private"));
   ...
   public final void pointerPressed(int var1, int var2) {
      if (y != null) {
         String var14 = y.get("a").toString();
         if (y.get("a").toString() == "a") {
            String[] var13 = (String[])y.get("c");
            int var15 = Integer.parseInt(y.get("r").toString());
            int var16 = Integer.parseInt(y.get("q").toString());
            int var17 = Integer.parseInt(y.get("d").toString());
            int var18 = Integer.parseInt(y.get("m").toString());
            int var19 = var16 / var13.length;
            if (var1 >= var17 && var1 <= var17 + var15 && var2 >= var18 && var2 <= var18 + var16) {
               for(int var11 = 0; var11 < var13.length; ++var11) {
                  if (var2 > var18 + var19 * var11 && var2 < var18 + var19 * (var11 + 1)) {
            ...
            int var12 = Integer.parseInt(y.get("t").toString());
            if (var2 >= h - j && var1 <= g / 3) {
               this.a(((String[])y.get("e"))[var12], ((String[])y.get("f"))[var12]);
               y = null;
               return;
            }
         ...
         af var3 = this;
         if (this.t != null) {
            for(int var9 = 0; var9 < this.t.size(); ++var9) {
               Hashtable var10;
               int var7 = Integer.parseInt((var10 = (Hashtable)var3.t.elementAt(var9)).get("d").toString());
               int var8 = Integer.parseInt(var10.get("m").toString());
               int var5 = Integer.parseInt(var10.get("r").toString());
               int var6 = Integer.parseInt(var10.get("q").toString());
      ...
      if (var1 == "p") {
         ...
         if (var1 == "r") {
            if (var2 == A) {
               ...
               this.c();
               Vector var6;
               (var6 = new Vector()).addElement(as.a("n", a(6, 1), 5, "", "", as.c, "", as.b, this.m[0], -1, -1, as.d, 0));
               this.n.addElement(as.a(var6, g, j, this.m[6], -1, "n", "", ""));
               (var6 = new Vector()).addElement(as.a("n", a(8, 1) + "：", 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.e, 0));
               this.n.addElement(as.a(var6, g, j, -1, -1, "n", "", ""));
               (var6 = new Vector()).addElement(F);
               this.n.addElement(as.a(var6, g, j, -1, -1, "n", "", ""));
               (var6 = new Vector()).addElement(as.a("n", a(5, 1) + "：", 5, "", "", as.c, "", as.a, this.m[1], -1, -1, as.e, 0));
               this.n.addElement(as.a(var6, g, j, -1, -1, "n", "", ""));
               ...
               this.n.addElement(as.a(var6, g, j, -1, -1, "n", "", ""));
               as.a(this.n, 5, -1, g);
               (var6 = new Vector()).addElement(as.a("y", a(80, 1), 5, "m", String.valueOf(2), as.c, "", as.b, this.m[1], this.m[4], -1, as.e, g - 10));
               this.n.addElement(as.a(var6, g, j, -1, -1, "n", "", ""));
               as.a(this.n, 20, this.m[2], g);
               (var6 = new Vector()).addElement(as.a("n", "优视科技 版权所有", 5, "", "", as.c, "", as.a, this.m[4], -1, -1, as.e, g - 10));
               this.n.addElement(as.a(var6, g, j, this.m[2], -1, "n", "", ""));
               as.a(this.o, a(0, 0), var16, var3);
               as.a(this.p, a(1, 0), var1, var2);
               this.ba = false;
               this.u = 4;
               return;
            }
            ...
            if (var1 == "t") {
               y = null;
               int var11;
               if ((var11 = Integer.parseInt(var2)) == true) {
   ...
   private void a(Hashtable var1, int var2, int var3, int var4, int var5) {
      if (this.s != null) {
         if (this.u == 5 && var1 != null) {
            ...
            this.t.addElement(as.a(var4, var2, var5, var3));
         } else {
            ...
            if (System.currentTimeMillis() - this.v >= 50L) {
               ...
               if (this.s != null && this.s.size() != 0) {
                  for(int var12 = 0; var12 < var8.s.size(); ++var12) {
                     if (var8.s.elementAt(var12) == var8.r) {
                        var10000 = var12;
                        break label129;
                     }
                  }
               ...
               if (this.u == 1) {
                  ...
                  if (this.u == 3) {
                     String var10 = this.r.get("e").toString();
                     String var13 = this.r.get("f").toString();
                     if (var10 != "q") {
                        if (var10 == "n") {
                           var4 = Integer.parseInt(this.r.get("n").toString());
                           String var6 = this.r.get("s").toString();
                           String var11 = this.r.get("c").toString();
                           TextBox var7;
                           (var7 = new TextBox(var6, var11, var4, 0)).addCommand(this.M);
                        ...
                        if (var10 == "m") {
                           this.u = -1;
                           this.P = (byte)Integer.parseInt(var13);
                           return;
                        }
   ...
   private int b(int var1) {
      ...
      if (F.get("c").equals("") || G.get("c").equals("")) {
         as.a(y, a(23, 0));
         return -1;
      } else if (!e(F.get("c").toString()) || !e(G.get("c").toString())) {
         as.a(y, "错误：您输入的账号密码中含有非法字符，请检查！");
         return -1;
      } else if (!f(F.get("c").toString())) {
         as.a(y, "错误：请输入由数字组成的账号/手机号。");
         return -1;
      } else {
         if (var1 == 1) {
            if (H.get("c").equals("")) {
         ...
         if (var4 < 0) {
            String var6 = a(var3, 2, "#");
            var2 = a(var3, 3, "#");
            if (var4 != -102) {
               as.a(y, "网络繁忙，连接失败，本次支付不成功，请返回尝试重新支付。");
               this.d();
               return var4;
            } else if (var6.equals("uc_password_error")) {
               as.a(y, "您的账号或密码错误，请重新输入。");
               this.a("r", A);
               return -1;
            } else if (var6.equals("um_system_error")) {
               as.a(y, "系统错误，支付失败，U点未被扣除，请重试或更换其他支付方式！");
               aQ = "";
               this.d();
               return -1;
            } else if (var6.equals("um_account_error")) {
               as.a(y, "您的账户余额不足，无法完成本次支付，请用UC浏览器登录UC充值中心(pay.uc.cn)为U点账户充值。");
               this.d();
               return -1;
            } else if (var6.equals("um_paypwd_error")) {
               if (this.ba) {
                  as.a(y, "支付失败，原因：" + var2);
               } else {
                  y = null;
   ...
   private String a(String var1, String var2, String var3, String var4, int var5) {
      if (var1 != null && var2 != null) {
         ...
         String var11 = (var8.length() <= 5 ? var8 : var8.substring(0, 5))
            + (this.Y.length() <= 5 ? this.Y : this.Y.substring(0, 5))
            + (this.q.length() <= 5 ? this.q : this.q.substring(0, 5))
            + this.V;
         var11 = var6.a(var11);
         var4 = var4.equals("") ? a(false) : var4;
         String var12 = var4 + "`" + var1 + "`" + var2;
         var13 = new String(at.b("ucweb#20100518").toUpperCase().substring(0, 10).getBytes());
         var2 = ao.a(var12, var13);
         var12 = "";
         ...
         StringBuffer var22;
         (var22 = new StringBuffer()).append("user_id=" + var8);
         var22.append("&cpid=" + this.Y);
         var22.append("&gameid=" + this.q);
         var22.append("&optid=" + this.R);
         var22.append("&u_money=" + this.V);
         var22.append("&charge=" + var10);
         var22.append("&consume_id=" + var9);
         var22.append("&ucid=" + var1);
         var22.append("&sign=" + var11);
         var22.append("&uc_token=" + var2);
         var22.append("&pay_pwd=" + var12);
         var22.append("&consume_time=" + var4);
         var22.append("&tm=" + var4);
         var22.append("&eid=4");
         var22.append("&ch_code=" + this.ap);
         ap var16 = new ap(var7, Q, var22.toString(), aO, aZ);
         ...
         try {
            ...
            Hashtable var17;
            if ((var17 = ap.a(var16, Z, "")) == null) {
               as.a(y, a(39, 1) + ": -904 " + a(37, 1));
               return "-904#nullcontent";
            }

            int var20 = Integer.parseInt(var17.get("respCode").toString());
            if (var17 == null || var20 < 200 || var20 > 299) {
               return "-905#ResponseCode=" + var20;
            }
   ...
   private boolean c(int var1) {
      ...
      String var5 = new at()
         .a(
            (var3.length() <= 5 ? var3 : var3.substring(0, 5))
               + (this.Y.length() <= 5 ? this.Y : this.Y.substring(0, 5))
               + (this.q.length() <= 5 ? this.q : this.q.substring(0, 5))
               + e(this.T)
         );
      ...
      ap var9 = new ap(var2, Q, var6.toString(), aO, aZ);

      try {
         Hashtable var10;
         if ((var10 = ap.a(var9, Z, "")) == null) {
            return false;
         }
   ...
   private static String[] a(String var0, char var1, int var2) {
      if (var2 <= 0) {
         ...
         while((var3 = var0.indexOf(10, var3 + 1)) >= 0) {
            ++var1;
         }
      ...
      for(int var7 = 0; var7 < var2; ++var7) {
         ...
         if ((var4 = var0.indexOf(10)) == -1) {
            ...
            var6[var7] = var0.substring(0, var4);
   ...
   private static String c(String var0, String var1) {
      ...
      for(int var5 = 0; var4 < var7.length() / 4; ++var5) {
         if (var5 == var9.length()) {
            var5 = 0;
         }

         int var6 = Integer.parseInt(var7.substring(var4 << 2, (var4 << 2) + 4));
         var2[var4] = (char)((char)var6 ^ var9.charAt(var5));
         ++var4;
      }

      for(int var10 = 0; var10 < var7.length() / 4; ++var10) {
         var3 = var3 + var2[var10];
      }
   ...
   private static String d(int var0) {
      a();
      String var1;
      if ((var1 = as.a("locale", ai)).equals("")) {
         aE = aG;
         return "";
      } else {
         String[] var5;
         if ((var5 = b(var1, ",")).length < 3) {
            aE = aG;
            return "";
         } else {
            aH = var5;
            int var6 = Integer.parseInt(var5[2]);
            String var4;
            if (aH[1].equals("元")) {
               int var2 = var0 * var6 / 100;
               if ((var0 = var0 * var6 % 100) < 10) {
                  var4 = var2 + ".0" + aH[1];
               } else {
                  var4 = var2 + "." + var0 + aH[1];
               }
   ...
   private static boolean a(String var0, String var1, int var2) {
      if (var0 == null || "".equals(var0.trim())) {
         return false;
      } else if (var1 != null && !"".equals(var1.trim())) {
         var0 = "sms://" + var0;
   ...
   private void n() {
      ...
      if (this.T > 0 && this.T < this.V) {
         String var6 = a(8, 0) + "，" + a(10, 0);
         var1.addElement(a(a(a(var6, "$(str3)", this.as), "$(str2)", String.valueOf(this.az - this.aB)), "$(str1)", String.valueOf(this.aB)) + au);
      } else {
         String var2 = a(9, 0) + "，" + a(10, 0);
         var1.addElement(a(a(a(var2, "$(str2)", this.as), "$(str1)", String.valueOf(this.az)), "$(str3)", d(this.V)) + au);
      }

      String[] var7 = new String[]{a(20, 0)};
      Vector[] var5 = new Vector[]{var1};
      String var3 = "r";
      String var4 = z;
      this.a(var7, var5, a(0, 0), "o", "", a(1, 0), var3, var4, a(0, 0), "m", String.valueOf(4));
   }
   ...
   private void o() {
      ...
      int var23 = Integer.parseInt(var3.substring(6, 8));
      long var15 = a(var4, var5, var23);
      var4 = Integer.parseInt(var1.substring(0, 4));
      var5 = Integer.parseInt(var1.substring(4, 6));
      int var24 = Integer.parseInt(var1.substring(6, 8));
      long var17 = a(var4, var5, var24);
      if ((int)((var15 - var17) / 1000L / 60L / 60L / 24L) > this.aw && !this.e()) {
         ...
         if (var22 != null && var22.length >= 2) {
            ...
            this.ax = Integer.parseInt(var22[3]);
            if (this.V % this.aA > 0) {
               ++this.az;
            }
   ...
   public static final boolean a(MIDlet var0, Displayable var1, String var2, String var3, String var4, String var5, String var6, int var7) {
      if (b(var5) < var7) {
         return true;
      } else if (var7 % 20 == 0 && var7 >= 20) {
         Display var8 = Display.getDisplay(var0);
         af var11;
         af var12 = var11 = a = new af(var0, var4, 0, 0, 0, 0, var7);
         var11.w = true;
         var12.d = false;
         var12.R = var5;
         var12.S = var6;
