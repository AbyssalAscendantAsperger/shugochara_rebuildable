...
public final class aa extends h {
   ...
   public static final int aM = 1 << x.D + 0;
   public static final int aN = 1 << x.D + 1;
   public static final int aW = 1 << x.D + 2;
   public static final int aX = 1 << x.D + 3;
   ...
   public final void a() {
      ...
      this.y(super.W[59]);
      this.y(super.W[61]);
      w.f.removeAllElements();
      w.c.removeAllElements();
      w.d.removeAllElements();
      w.e.removeAllElements();
      w.a(2, 1);
      w.a(0, 5);
      w.a(1, 5);
      this.aL();
   ...
   public final i a(Graphics var1, int var2, int var3) {
      if (super.W[74] >= 0) {
         i var4;
         (var4 = l.e[4]).a((short)super.W[74], this.bz);
      ...
      if (super.W[70] == 2) {
         ...
         for(int var5 = 0; var5 < this.bM.length; var5 += 5) {
            if (this.bM[var5] != -1) {
               l.e[super.V[6]]
                  .a(var1, this.bM[var5 + 0], this.bM[var5 + 1], this.bM[var5 + 2] - ac.h(), this.bM[var5 + 3] - ac.j(), this.bM[var5 + 4] == 0, super.X);
            }
         }
      }
   ...
   public final void a(short var1) {
      ...
      switch(var1) {
         ...
         default:
            break;
         case 10:
            int[] var2 = p.a(super.V[15], super.V[8], super.V[9], p.a(super.V[6], 2));
            super.p = var2[0];
            super.q = var2[1];
            break;
         case 11:
            this.j();
            int[] var3 = p.a(super.V[15], super.V[8], super.V[9], this.bb);
            super.p = var3[0];
            super.q = var3[1];
      }
   ...
   public final boolean d() {
      ...
      if (super.ap <= 0) {
         ...
         if (!this.m(x.P | x.Q)) {
            this.g();
            if (av.D == 4 && !this.m(aN) && !this.c((short)13) && !super.m[2]) {
               this.ar();
            }
         }
      ...
      if (t.f[35] == 0 && av.t.b.c(5) && av.t.b.c(4) && av.t.b.c(3) && av.t.b.c(2) && av.t.b.c(1)) {
         t.f[35] = 1;
         av.t.b.b(35);
         g.a("获得称号: " + t.a[0][35]);
         g.e = true;
      ...
      if (ai.b && this.Y() && this.bL == super.V[3]) {
         ai.b = false;
         ai.a = false;
         this.bL = -1;
      }
   ...
   private void ay() {
      ...
      if (this.Y()) {
         ...
         if (a.e(16384)) {
            ...
            if (this.bh++ < 2 && av.t.bf[0].j != 5 && av.t.bf[0].j != 6) {
               if (super.W[75] >= 33) {
         ...
         if (this.af()) {
            ...
            if ((var1 = this.C() * 30) >= 120) {
               if (this.V() == 1 && this.ab() < var1) {
                  var1 = this.ab() - 10;
               } else if (this.V() == 0 && j.a() - this.ab() < var1) {
                  var1 = j.a() - this.ab() - 10;
               }
               ...
               for(int var3 = var1 >> 3; var2 <= var3; ++var2) {
                  ...
                  if (j.a(var6, var7) > 0 || super.A != null && super.A.b && !super.A.a(this, var6, var7)) {
   ...
   public final h ao() {
      ...
      for(int var4 = 0; var4 < av.z; ++var4) {
         x var6;
         if ((var6 = av.d(av.A[var4])) != null && var6.o(1) && var6.m(x.H) && !var6.m(x.P | x.Q) && var6 instanceof h && this.c(var6)) {
   ...
   public final boolean c(x var1) {
      int var2;
      if ((var2 = this.V()) == true && var1.V[8] < super.V[8] || var2 == false && var1.V[8] > super.V[8]) {
   ...
   public final int aq() {
      ...
      if ((var1 = this.z()) == null) {
         ...
         for(int var4 = 0; var4 < av.x; ++var4) {
            short[] var5;
            x var7;
            if ((var7 = av.w[av.y[var4]]) != null
               && var7.m(x.I)
               && var7.m(x.H | x.K)
               && (av.h[var7.V[0]] & 1) == 1
               && !var7.m(x.P)
   ...
   public final void b(Graphics var1) {
      ...
      if (ba > 0) {
         ...
         o.a(var1, bF, String.valueOf(ba), 238 - bE.getWidth() - 4, 98, 40, 1, 0, 10);
         if (av.g(2) < ba) {
            av.b(ba, 2);
         }
   ...
   public final void c(Graphics var1) {
      if (super.j != null && !super.j.m(x.Q) && super.j.aH && super.j.o(6)) {
         Object var2 = null;
         boolean var3;
         ...
         if (super.j instanceof v && (var6 = (var5 = (v)super.j).W[81]) >= 0) {
            ...
            bK.d = 0;
            bK.e = var6;
            short[] var11 = k.a((short)2, (short)(var3 ? 1 : 2));
            bK.b(var11[0] + (var11[2] >> 1), var11[1] + (var11[3] >> 1));
         }

         short[] var12 = k.a((short)2, (short)(var3 ? 5 : 14));
         ...
         if (var16 > 1) {
            var8 = (var16 - 1) % bH;
            o.a(var1, var12, bG[var8 > 0 ? var8 - 1 : bH - 1]);
         }

         if (var7 > 0) {
            o.a(var1, var12[0], var12[1], var12[2] * var7 / var13, var12[3], bG[var8]);
         } else if (super.j.W[5] > 0) {
            o.a(var1, var12, bG[var8]);
         }
         ...
         if (var16 > 1) {
            ...
            short[] var10 = k.a((short)2, (short)(var3 ? 6 : 17));
            o.a(var1, var9, "x" + var16, var10[0] + var10[2], var10[1] + var10[3], 40, 1, 0, 11);
         }
      }
   }
            ...
            if ((var1 = this.au()) < 0) {
               ...
               switch(super.V[3]) {
                  ...
                  default:
                     break;
                  case 3:
                     if (super.j == null || !this.b(super.j.ae()) || !a.b(z.a(this.b(super.j, 2)))) {
                        if (a.e(16384)) {
                           this.aI();
                        } else {
                           this.aK();
   ...
   private void d(byte var1) {
      switch(var1) {
         case 0:
            if (a.c(4) || a.c(6) || a.c(5)) {
               this.u(1);
               return;
            }

            if (a.c(8) || a.c(10) || a.c(9)) {
               this.u(0);
               return;
            }
            break;
   ...
   private void F(int var1) {
      if (!this.bj && super.aE == 0) {
         if (!this.a.e(var1)) {
            ...
            if (this.G(var1)) {
               this.by = var1;
               super.e = (short)(this.a.a((byte)var1, 13) * ae.b);
               switch(var1) {
                  case 0:
                     this.bw = 5;
   ...
   public final void a(Object[] var1, DataInputStream var2) throws Exception {
      for(int var5 = 0; var5 < var1.length; ++var5) {
         switch(var2.readByte()) {
            ...
            case 2:
               t var4;
               (var4 = t.a(this.be, var2.readShort())).a(var2);
               var1[var5] = var4;
         }
   ...
   public final int au() {
      if (this.bj) {
         ...
         for(int var2 = 0; var2 < bk.length; ++var2) {
            if (bl[var2] && a.e(bk[var2]) && bm[var2] >= 0) {
               return bm[var2];
            }
         }
   ...
   public final void a(Graphics var1, int var2, short[] var3) {
      if (this.bP[var2] > 0) {
         int var4;
         if ((var4 = this.a.a(var2, 13) * ae.b) <= 0) {
            return;
         }
   ...
   public final void e(Graphics var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.bp.length; ++var4) {
         if (this.bp[var4] > 0) {
            if (bs[var4] != -1) {
               i var5;
               (var5 = l.e[4]).a(bs[var4], this.bo[var4]);
